...
export const projects: Project[] = [
  {
    ...
    description:
      "A fully bespoke, conversion-focused website for a Lagos luxury car dealership. Custom editorial design, live inventory managed through a CMS, WhatsApp enquiry integration on every listing, finance estimator, and full mobile optimisation.",
    imageSrc: "/img/meridian/vehicle-details-ferrari.png",
    images: [
      "/img/meridian/vehicle-details-ferrari.png",
      "/img/meridian/vehicle-details-mulsanne.png",
      "/img/meridian/landing-hero-cullinan.png",
      "/img/meridian/landing-logos-featured.png",
      "/img/meridian/landing-featured-mobile.png",
      "/img/meridian/vehicle-details-porsche.png",
      "/img/meridian/about-hero.png",
      "/img/meridian/about-leadership.png",
      "/img/meridian/about-showroom.png",
      "/img/meridian/details-ferrari-desc-fiancing.png",
      "/img/meridian/financing-hero.png",
      "/img/meridian/details-ferrari-specs-fiancing.png",
      "/img/meridian/financing-calculator.png",
      "/img/meridian/inventory-grid.png",
    ],
    imageAlt: "Meridian Motors project preview",
    imageContain: true,
    liveUrl: "https://meridian.tiskae.dev",
    githubUrl: undefined,
    tags: ["Next.js", "GSAP", "Sanity CMS", "SASS"],
  },
  {
    title: "FitSit",
    description:
